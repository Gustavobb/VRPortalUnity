        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                if (col.r > 0.99 && col.g > 0.99 && col.b > 0.99) 
                    col = 0.5 + 0.5*cos(_Time.y+uv.xyx+float3(0,2,4));
